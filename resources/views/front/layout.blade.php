                            ...
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p>tuchithanh1998@gmail.com
                                        <br>diemnguyen1459@gmail.com
                                        <br>phamngocthach1201@gmail.com</p>
                                    </div>
                                </div>
                                <!-- social -->
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#canhiem').html('<strong>Ca nhiễm :</strong>'+data.results[0].total_cases);
                    $('#tuvong').html('<strong>Ca tử vong :</strong>'+data.results[0].total_deaths);
                    $('#phuchoi').html('<strong>Ca phục hồi :</strong>'+data.results[0].total_recovered);
